  ...
  render() {
    return (
      <div className="db-card">
        <div className="top">
          <h4 className="left">In-review</h4>
          <div className="right">
            <a href=""><i className="material-icons">search</i></a>
            <a className="dropdown-button" href="#" data-activates='card-filter-2' data-beloworigin="true" data-alignment="right"><i className="material-icons">filter_list</i></a>
            <a href="" onClick={this.props.removeCard}><i className="material-icons">close</i></a>
            <div id='card-filter-2' className='dropdown-content'>
          ...
          <div className="row single">
            ...
            <div className="col s6 right-align">
              ...
              <div className="info right-bottom">
                <a href="#" className="approve">Approve</a>
                <a href="#" className="deny">Deny</a>
              </div>
            </div>
          </div>
          <div className="row single">
