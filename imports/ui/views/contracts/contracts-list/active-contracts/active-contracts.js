import './active-contracts.html';
import { Contracts } from '/imports/api/contracts/contracts';
import '../../create-edit-contract/contractCreateModalCentre'


Template.activeContracts.onCreated(function () {
...
Template.activeContracts.onRendered(function () {
    let self = this;
...
Template.activeContracts.helpers({
    userName(userId){
    ...
    contracts() {
        return Contracts.find({status: {$in:['pending', 'active']}});
    },
    isChecked() {
        let id = this._id;
...
Template.activeContracts.events({
