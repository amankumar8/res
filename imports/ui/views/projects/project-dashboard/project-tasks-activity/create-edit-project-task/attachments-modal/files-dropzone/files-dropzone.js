...
Template.filesDropZone.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        this.filesToUpload.set(newTaskFiles);
    });
});
...
Template.filesDropZone.onRendered(function () {
    ...
    let dropzone = new Dropzone('form#taskAttachmentsForm', {
        url: "/target-url",
        addRemoveLinks: true,
    ...
    dropzone.on('addedfile', function(file) {
        ...
        if (file.size >= 5 * 1000000) {
            ...
            let isImage = (/application\//g).test(file.type);
...
Template.filesDropZone.helpers({
    ...
    taskFiles() {
        ...
        let filesToUpload = tmpl.filesToUpload.get();
        let taskFiles;
